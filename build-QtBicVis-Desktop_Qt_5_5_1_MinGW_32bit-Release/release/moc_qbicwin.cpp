...
struct qt_meta_stringdata_qGoFilter_t {
    QByteArrayData data[1];
    char stringdata0[10];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_qGoFilter_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_qGoFilter_t qt_meta_stringdata_qGoFilter = {
    {
QT_MOC_LITERAL(0, 0, 9) // "qGoFilter"
...
static const uint qt_meta_data_qGoFilter[] = {
...
void qGoFilter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObject qGoFilter::staticMetaObject = {
    { &QSortFilterProxyModel::staticMetaObject, qt_meta_stringdata_qGoFilter.data,
      qt_meta_data_qGoFilter,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *qGoFilter::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *qGoFilter::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_qGoFilter.stringdata0))
        return static_cast<void*>(const_cast< qGoFilter*>(this));
    return QSortFilterProxyModel::qt_metacast(_clname);
}

int qGoFilter::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
